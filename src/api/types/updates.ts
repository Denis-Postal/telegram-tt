...
export type ApiUpdateSaveBotCache = {
  '@type': 'saveBotCache';
  snapshot: import('../botApi/store').BotStoreSnapshot;
};

export type ApiUpdateClearBotCache = {
  '@type': 'clearBotCache';
};

export type ApiUpdateBotMessagesUpdated = {
...
export type ApiUpdate = (
  ...
  ApiRequestReconnectApi | ApiRequestSync | ApiUpdateSaveBotCache | ApiUpdateClearBotCache | ApiUpdateBotMessagesUpdated | ApiUpdateFetchingDifference | ApiUpdateChannelMessages |
