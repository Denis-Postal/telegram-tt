...
import { botFetchChats, botFetchFullChat, botFetchPeerSettings, botFetchPinnedDialogs, botSearchChats, ensureBotSession, isBotSession } from '../../botApi';
...
export async function fetchPeerSettings(peer: ApiPeer) {
  if (isBotSession()) {
    return botFetchPeerSettings(peer);
  }
