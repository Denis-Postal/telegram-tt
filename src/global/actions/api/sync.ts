...
import { getIsApiReady } from '../../../api/gramjs/helpers/apiReady';
...
addCallback((global: GlobalState) => {
  ...
  if (tabState && !tabState.isMasterTab) {
    previousGlobal = global;
    return;
  }
  if (isSynced || !getIsApiReady() || (previousGlobal?.connectionState === connectionState
